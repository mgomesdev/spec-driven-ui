...
- **Resolução de Tokens:** Use o `TOKENS_GLOBAL_ID` como verdade absoluta. Substitua valores fixos (ex: `14px`) pelos tokens correspondentes (ex: `--text-sm`). Mantenha valores manuais apenas se o token não existir.
