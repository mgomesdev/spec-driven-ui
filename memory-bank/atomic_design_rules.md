...
- **Resolução de Tokens:** Use o `tokens_source` como verdade absoluta. Substitua valores fixos (ex: 8px) pelos tokens correspondentes (ex: $radius_sm). Mantenha valores manuais apenas se o token não existir.
