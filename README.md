...
tasks     →  tasks.md     →  [👤 revisão humana]
    │
    ▼
orchestrator  →  implementa US-001  → atualiza progress.md ->  commit
                 implementa US-002  → atualiza progress.md ->  commit
                 implementa US-003  → atualiza progress.md ->  commit
                 ...
                 ✅ CONCLUÍDO -> destilação do conhecimento nos padrôes globais do projeto -> limpa o progress.md -> humano faz a PR.
```
...
**Como acionar:**
- "gere o research para para [nome-da-feature]"
...
**Como acionar:**
- "gere o plan para [nome-da-feature]"
...
**Como acionar:**
-  "gere as tasks.md para [nome-da-feature]"
...
**Como acionar:**
- "execute as tasks da [nome-da-feature]"
