import type { ContactLink } from '@/types/sobre';
...
export const ContactSection = ({ contact }: ContactSectionProps) => (
  <section className="py-16 px-4 md:px-8">
    <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl md:text-3xl font-bold mb-8 text-white">Contato</h2>
      <div className="flex flex-wrap gap-4">
        {contact.map((link) => (
          <a
            ...
            className="flex items-center gap-3 px-5 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-colors"
          >
