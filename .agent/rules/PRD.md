...
4. Salve em `**output-folder**/prd-[nome-da-feature].md`
...
- **Formato:** Markdown (`.md`)
- **Localização:** `**output-folder**/features`
...
- [ ] Salvo em `**output-folder**/prd-[nome-da-funcionalidade].md`