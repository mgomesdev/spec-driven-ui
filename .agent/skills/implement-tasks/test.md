...
2. Leia o registro de progresso em `/specs/features/[branchName]/progress.md` (consulte primeiro a seção `Padrôes do projeto`).
...
2. **Verifique se o arquivo AGENTS.md já existe** - Procure por AGENTS.md nesses diretórios ou em diretórios pai.
...
**Exemplos de boas adições ao AGENTS.md:**
